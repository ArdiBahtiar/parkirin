            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link">Already have an account? <a href="/authentication/login">Log in</a></p>
                        <form class="text-left" action="{{ url('/auth/registry') }}" method="POST">
                            @csrf
                            <div class="form">

                                <div id="username-field" class="field-wrapper input">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="username" name="name" type="text" class="form-control" placeholder="Username" required>
                                </div>
                                ...
                                <div id="phone-field" class="field-wrapper input mb-2">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input id="phone" name="phone" type="number" min="0" value="" placeholder="Phone Number" required>
                                    </div>
                                </div>

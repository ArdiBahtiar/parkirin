    ...
    <div class="topbar-nav header navbar" role="banner">
        <nav id="topbar">
            ...
            <ul class="list-unstyled menu-categories" id="topAccordion">
                ...
                <li class="menu single-menu  {{ ($category_name === 'posts') ? 'active' : '' }}">
                    <a href="#posts" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#topAccordion">
                        <li class="{{ ($page_name === 'analytics') ? 'active' : '' }}">
                            <a href="/posts/items"> List </a>
                        </li>
                        <li class="{{ ($page_name === 'createPost') ? 'active' : '' }}">
                            <a href="/posts/items/create"> Create </a>
                        </li>
                        <li class="{{ ($page_name === 'bookmarks') ? 'active' : '' }}">
                            <a href="/bookmarks/items"> Bookmarked </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu single-menu {{ ($category_name === 'components') ? 'active' : '' }}">
                    ...
                    <ul class="collapse submenu list-unstyled" id="components" data-parent="#topAccordion" style="width: 50vw; max-width: 500px; height: auto; max-height: 55vh;">
                        <form action="{{ url('/posts/filter') }}">
                            ...
                            <div class="modal-body">
                                <div class="">Range Harga</div>
                                <div class="row mb-4">
                                    <div class="col">
                                        <input type="number" class="form-control" placeholder="min" name="minHarga">
                                    </div>
                                    <div class="col">
                                        <input type="number" class="form-control" placeholder="max" name="maxHarga">
                                    </div>
                                </div>

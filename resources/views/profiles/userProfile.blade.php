                        ...
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                <div class="d-flex justify-content-between">
                                    <h3 class="">Profile</h3>
                                    @if($user == Auth::user())
                                    <a href="/users/account_settings/{{$user->id}}" class="edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
                                    @endif
                                </div>
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="bio-skill-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-xl-6 col-lg-12 mb-xl-2 mb-5 ">
                                        ...
                                        <div class="col-12 col-xl-6 col-lg-12 mb-xl-2 mb-0 ">
